 ...
 */
public final class Draenel<T extends ClaseBase> extends Guardianes<T> {
	public Draenel(String nickname, T clase) throws ClaseNoAceptadaParaRazaException {
		super(nickname, clase);
	}

	public Draenel(String nickname, T clase, int lvl) throws ClaseNoAceptadaParaRazaException {
